...
<head>
    ...
    <title>{{ $year }} Bid Directory</title>
    <style>
        @page {
    ...
    @if ($mode === 'print')
        <div class="toolbar">
            <div class="toolbar-inner">
                <p>
                    <strong>{{ $year }} bid directory</strong>
                    Print-ready list of {{ $totalCount }} {{ \Illuminate\Support\Str::plural('bid', $totalCount) }}.
                </p>
                <div class="actions">
                    <a href="{{ $indexUrl }}">Back to bids</a>
        ...
        <div class="body">
            <table class="stats">
                <tr>
                    ...
                    <td>
                        <span class="stat-value">{{ $withPricingCount }}</span>
                        <span class="stat-label">With pricing</span>
                    </td>
                    <td>
                        <span class="stat-value">{{ $withoutPricingCount }}</span>
                        <span class="stat-label">Without pricing</span>
                    </td>
                </tr>
            </table>
