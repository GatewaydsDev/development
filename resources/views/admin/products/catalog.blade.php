...
<head>
    ...
    <title>{{ $year }} Product Catalog</title>
    <style>
        @page {
    ...
    @if ($mode === 'print')
        <div class="toolbar">
            <div class="toolbar-inner">
                <p>
                    <strong>{{ $year }} product catalog</strong>
                    Print-ready list of {{ $totalCount }} {{ \Illuminate\Support\Str::plural('product', $totalCount) }}.
                </p>
                <div class="actions">
                    <a href="{{ $indexUrl }}">Back to products</a>
    ...
    <div class="page">
        ...
        <div class="body">
            ...
            <p class="footnote">
                ...
                · Confidential product directory
            </p>
        </div>
    </div>
</body>
